...
const PostDetailScreen = ({ route, navigation }) => {
  ...
  const eventShare = async () => {
    const shareOptions = {
      message:
        "Please join me with this fantastic event! Event Detail: www.google.com",
    };
    ...
    const unsubscribe = onValue(commentsRef, (snapshot) => {
      ...
      for (let key in data) {
        if (data[key].eventId === id) {
          // Check if the comment is related to this event only
    ...
    <SafeAreaView style={styles.container}>
          ...
          <View style={styles.container}>
            ...
            >
              <Image
                ...
                source={require("../../assets/tabicon/share.png")}
              />
            </TouchableOpacity>
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <Text>
            If you like this event, please share it with your friends.
          </Text>
